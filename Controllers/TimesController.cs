...
namespace Fut.Controllers
{
    public class TimesController : Controller
    {
        ...
        public TimesController(FutContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Abrev,Cidade")] Time time)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Nome,Abrev,Cidade")] Time time)
        {
            if (id != time.Id)
            {
                return NotFound();
